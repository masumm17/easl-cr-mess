...
return array(
	...
	'base' => 'cr_expanding_images',
	'icon' => 'icon-wpb-ui-accordion',
	'is_container' => true,
	'show_settings_on_create' => false,
	'as_parent' => array(
		'only' => 'cr_expanding_image_item',
	),
	'category' => __( 'Cheval Residences', 'crvc_extension' ),
	'description' => __( 'Expanding Images', 'crvc_extension' ),
	'params' => array_merge(
		array(
			array(
				'type' => 'textfield',
	...
	'js_view' => 'CrScExpandingImagesView',
	'php_class_name' => 'CR_VcE_Sc_Expanding_Images'
);
