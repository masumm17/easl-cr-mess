...
return array(
	...
	'base' => 'cr_fixed_width_grids_item',
	'class' => 'vc_col-sm-4',
	'icon' => 'icon-wpb-ui-accordion',
	'is_container' => false,
	'show_settings_on_create' => false,
	'as_child' => array(
		'only' => 'cr_fixed_width_grids',
	),
	'category' => __( 'Cheval Residences', 'crvc_extension' ),
	'description' => __( 'Fixed Width Grids Item', 'crvc_extension' ),
	'params' => array_merge(
		array(
			array(
				'type' => 'attach_image',
	...
	'php_class_name' => 'CR_VcE_Sc_Fixed_Width_Grids_Item'
);
